...
const table_option = ref({
    ...
    listColumns: {
        polygon: polygonsFromData,
        role: userRolesFromData,
        is_staff: [
            { id: true, text: 'Да' },
            { id: false, text: 'Нет' },
        ],
            ...
            <div class="col-xl-12 col-lg-12 col-sm-12 layout-spacing">
                <div class="panel br-6 p-0">
                    <div class="custom-table">
                        <v-client-table :data="store.state.UsersModule.users" :columns="columns" :options="table_option"
                            ref="table">
                            <template #afterFilterWrapper>
                                <button type="button" class="btn btn-primary me-4" @click="openNewUserModal">
                            ...
                            <template #is_active="props">
                                <div :data_sort="props.row.is_active" v-html="trueFalseBadge[props.row.is_active]"></div>
                            </template>
                            <template #is_staff="props">
                                <div :data_sort="props.row.is_staff" v-html="trueFalseBadge[props.row.is_staff]"></div>
                            </template>
