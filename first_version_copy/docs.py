...
class Doc:
    ...
    def get_weighing_act(self, visit_id: int):
        ...
        cell_map = {
            ...
            'truck_model': ['D7', 'D23', 'D39'],
            'truck_number': ['D8', 'D24', 'D40'],
        ...
        truck_model = visit.permit.truck.model.model
        truck_number = visit.permit.truck.reg_number
        ...
        self._fill_cells(ws, truck_model, cell_map['truck_model'])
        self._fill_cells(ws, truck_number, cell_map['truck_number'])
    ...
    def get_transport_invoice(self, visit_id: int):
        ...
        cargo_description = 'Объем груза %s м3, вес согласно Акту' \
                            ' взвешивания № %s от %s' % (
            visit.permit.truck.body_volume,
            invoice_num,
            invoice_date,
        )
        ...
        ws[cell_map.get('truck_model')] = truck_model
        ws[cell_map.get('truck_number')] = truck_number
